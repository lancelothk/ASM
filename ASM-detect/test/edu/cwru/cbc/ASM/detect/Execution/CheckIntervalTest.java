...
public class CheckIntervalTest {
    ...
    public void testCheckInterval() throws Exception {
        ...
        String outputFolder = "ASM/testData/interval/result";
        CheckInterval.checkInterval(chrSize, "1", referenceFile, inputFile, outputFolder);
    }

    @Test
    public void testCpGCount() throws NoSuchMethodException, InvocationTargetException, IllegalAccessException, IOException {
        Method countCpG = ChrCoverageSummary.class.getDeclaredMethod("countCpG", String.class, Integer.TYPE,
                                                                     Integer.TYPE);
