...
public class DetectionWithMappedRead extends Detection {
    ...
    private static boolean useRegionP;
    ...
    public static void main(
        ...
        DetectionWithMappedRead.useRegionP = true;
...
//        regionPercentExperiment(currUserHome);
    ...
    private String buildSummary(int length, List<RefCpG> refCpGList, List<MappedRead> mappedReadList, ASMGraph graph,
        ...
        if (useRegionP) {
            ...
            if (testCount / (double) refCpGList.size() >= this.region_percent_threshold) {
                sb.append('+');
            } else {
                sb.append('-');
            }
